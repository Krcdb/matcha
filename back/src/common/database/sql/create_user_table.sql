...
INSERT INTO users (fortytwo_id, email, username, first_name, last_name, password, date_of_birth, gender, sexual_preferences, biography, uuid, is_verified)
VALUES
  ('42_001', 'alice@example.com', 'alice42', 'Alice', 'Dupont', 'pass123', '1995-04-12', 'female', 'male', 'Love adventures and coding', 'uuid-alice', true),
  ('42_002', 'bob@example.com', 'bob42', 'Bob', 'Martin', 'pass123', '1992-08-21', 'male', 'female', 'Music is my life', 'uuid-bob', false),
  ('42_003', 'charlie@example.com', 'charlie42', 'Charlie', 'Durand', 'pass123', '1990-01-05', 'male', 'female', 'Traveler and foodie', 'uuid-charlie', true),
  ('42_004', 'diana@example.com', 'diana42', 'Diana', 'Leroy', 'pass123', '1998-07-30', 'female', 'male', 'Fitness enthusiast', 'uuid-diana', false);
